# `object_store_ffi_jll.jl` (v0.12.8+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/bd80100bda414419dec18a57a8aa5374bd460170/O/object_store_ffi/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/RelationalAI/object_store_ffi.git (revision: `57dd2a7637872affe84e0410c3a66197fc008a34`)
